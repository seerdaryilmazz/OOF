...
import QuoteExportDataModal from './QuoteExportDataModal';

export class QuoteExportQueueList extends TranslatingComponent {
    constructor(props) {
        super(props);
        this.state = {}
    }
    ...
    render() {
        return (
            <Card>
                <Grid>
                    ...
                    <GridCell width="1-1">
                        <DataTable.Table
                            ...
                            <DataTable.Text header="Revision" center={true} field="quote.revisionNumber" />
                ...
                <QuoteExportDataModal ref={(c) => this.dataModal = c} />
            </Card>
        );
    }
}
