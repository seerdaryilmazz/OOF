            ...
            <Grid divider = {true}>
                <GridCell width="1-1" margin="small">
                    <DataTable.Table data={this.props.agreement.insuranceInfos}>
                        <DataTable.Text header="Type" translator={this} field="insuranceType.name"/>
                        <DataTable.Text header="Insured By" translator={this} field="insuredBy.name"/>
...
InsuranceInfoList.contextTypes = {
