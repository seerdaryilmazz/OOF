    ...
    render(){
        ...
        <div>
                ...
                <Grid>
                    ...
                    <GridCell width="1-1">
                        <DistributionScheduleDetails data = {this.props.selectedItem.distributionScheduleRules}
                                                     lookups = {this.props.lookups}
                                                     onchange = {(value) => this.updateStateForSingleProperty("distributionScheduleRules", value)} />
                    </GridCell>
                </Grid>
        </div>
