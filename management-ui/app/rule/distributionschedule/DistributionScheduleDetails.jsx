            ...
            <Grid>
                ...
                <GridCell width="1-1">
                    <TimelineTable value={data}
                                  ...
                                  baseField="shipmentDeliveryDate"
                                  fillWeek={true}
                                  fields={[{id: "planCompletionDate", color: "orange", description: "Distribution plan should be completed until"},
                                      {id: "linehaulArrivalDate", color: "red", description: "Shipment should be arrived until"}]}/>
                </GridCell>
            </Grid>
        );
    }
