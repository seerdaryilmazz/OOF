...
import {BaseResponsibilityRuleForm} from "./BaseResponsibilityRuleForm";
import {BaseResponsibilityRuleList} from "./BaseResponsibilityRuleList";

export class BaseResponsibilityRuleMultiple extends TranslatingComponent {
    constructor(props) {
        super(props);
        this.state = {
            lookup: {},
    ...
    render() {
        ...
        let responsibilityRuleList =  data ? <BaseResponsibilityRuleList  ruleType={ruleType} data={data}
            ...
            <div>
                <Grid>
                    <GridCell width="1-1" noMargin={true}>
                        <CardHeader title="Base Rules"/>
                    </GridCell>
                    <GridCell width="1-1" noMargin={true}>
                        <BaseResponsibilityRuleForm lookup={lookup}
                                                data={selectedItem}
                                                ruleType={ruleType}
