...
import {DSLRuleEdit} from './DSLRuleEdit';

export class DSLRule extends TranslatingComponent {
    ...
    render() {
        ...
        return (
            <Card title="Advanced Rule Definition"
                  toolbarItems={[{name: "", library: "uikit", icon: this.retrieveShowHideIcon(), onclick: () => this.handleShowHideClick(), inDropdown: false}]}>
