...
export class RailwayTariffDetailsModal extends TranslatingComponent {
    constructor(props) {
        super(props);
        this.state = {};
    ...
    render() {
        ...
        return (
            <div>
                <Modal ref={(c) => this.modal = c} large={true} title="Railway Tariff Details" minHeight="500px"
...
RailwayTariffDetailsModal.contextTypes = {
