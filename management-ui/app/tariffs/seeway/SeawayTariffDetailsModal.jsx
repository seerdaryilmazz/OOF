...
export class SeawayTariffDetailsModal extends TranslatingComponent {
    constructor(props) {
        super(props);
        this.state = {};
            ...
            <Grid>
                <GridCell width="4-5">
                    <Grid>
                        ...
                        <GridCell width="1-4">
                            <span className="uk-text-primary">Ferry Name: </span>
                            <span>{tariff.parentSchedule.ferryName}</span>
                        </GridCell>
                        <GridCell width="1-4">
    ...
    render() {
        ...
        return (
            <div>
                <Modal ref={(c) => this.modal = c} large={true} title="Seaway Tariff Details" minHeight="500px"
...
SeawayTariffDetailsModal.contextTypes = {
