...
import {SeawayTariffList} from './SeawayTariffList';
import {SeawayTariffDetailsModal} from './SeawayTariffDetailsModal';

export class SeawayTariff extends TranslatingComponent {
    ...
    componentDidMount() {
        axios.all([
            RouteService.getRouteLegs(RouteService.SEAWAY)
    ...
    render() {
        let title = super.translate("Seaway Tariff");
        ...
        let tariffListBody = <SeawayTariffList ref={(c) => this.form = c} tariffs={tariffs} selectedItem={selectedItem}
        ...
        return (
            <Page title={title}>
                ...
                <SeawayTariffDetailsModal ref={(c) => this.detailsModal = c}/>
            </Page>
        );
    }
