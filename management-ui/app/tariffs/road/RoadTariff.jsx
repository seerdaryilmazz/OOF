...
import {RoadTariffList} from './RoadTariffList';
import {RoadTariffDetailsModal} from './RoadTariffDetailsModal';

export class RoadTariff extends TranslatingComponent {
    ...
    componentDidMount() {
        axios.all([
            RouteService.getRouteLegs(RouteService.ROAD)
    ...
    render() {
        let title = super.translate("Road Tariff");
        ...
        let tariffListBody = <RoadTariffList ref={(c) => this.form = c} tariffs={tariffs} selectedItem={selectedItem}
        ...
        return (
            <Page title={title}>
                ...
                <RoadTariffDetailsModal ref={(c) => this.detailsModal = c}/>
            </Page>
        );
    }
