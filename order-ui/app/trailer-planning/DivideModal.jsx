...
import {LocationService, ShipmentAssignmentPlanningService} from '../services';
...
export class DivideModal extends TranslatingComponent {
    ...
    handleSave() {
        ...
        this.divideSegments(segment, selectedXDock);
    };
    divideSegments(segment, selectedCrossDock) {
        let request = {segmentId: segment.id, warehouse: {id: selectedCrossDock.companyLocation.id, name: selectedCrossDock.name}};
        ShipmentAssignmentPlanningService.divideSegments(request).then((response) => {
            ...
            _.remove(allSegments, {id: segment.id});
            ...
            _.remove(selectedSegments, {id: segment.id});
