...
import ShipmentImportDataModal from './ShipmentImportDataModal';

export class ShipmentImportQueueList extends TranslatingComponent {
    constructor(props) {
        super(props);
        this.state = {}
    }
    ...
    render() {
        return (
            <Card>
                <Grid>
                    ...
                    <GridCell width="1-1">
                        <DataTable.Table
                            ...
                            <DataTable.Text header="Shipment Code" field="shipmentCode" />
                            <DataTable.Text header="External System Name" field="externalSystemName" />
                            <DataTable.Text header="Status" field="status" printer={new StatusPrinter()} center={true} />
                            <DataTable.Text header="Transferred At" field="createdAt" printer={new DateTimePrinter()} center={true} />
                            <DataTable.Text header="Execution Date" field="lastUpdated" printer={new DateTimePrinter()} center={true} />
                ...
                <ShipmentImportDataModal ref={(c) => this.dataModal = c} />
            </Card>
        );
    }
}
