...
import {VehicleRequirementValidator} from "./validation/VehicleRequirementValidator";

export class VehicleRequirementList extends React.Component {
    ...
    handleAddNew(){
        ...
        value.forEach((item, index) => {
            let validationResult = VehicleRequirementValidator.validate(item);
    ...
    render(){
        ...
        if(this.props.validation){
            setValidationError = <div className="uk-alert uk-alert-danger">{this.props.validation.message}</div>;
        }
        let details = value.map((item, index) => {
            ...
            return (
                <div key = {index} style = {style}>
                    <VehicleRequirement  features = {this.props.features} permissionTypes = {this.props.permissionTypes}
                                         value = {item}
