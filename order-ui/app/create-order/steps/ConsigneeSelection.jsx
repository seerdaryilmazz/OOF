...
export class ConsigneeSelection extends React.Component {
        ...
        return(
            <Grid>
                <GridCell width="1-1" noMargin = {true}>
                    <span className = "uk-text-truncate uk-text-bold">{option.consigneeCompany ? option.consigneeCompany.name : ""}</span>
                </GridCell>
                <GridCell width="1-1" noMargin = {true}>
                    <span className = "uk-text-truncate" style = {{opacity: .8}}>{option.unloadingLocation ? option.unloadingLocation.name : ""}</span>
                </GridCell>
                <GridCell width="1-1" noMargin = {true}>
                    <span className="uk-text-truncate uk-text-small">{option.unloadingCompany ? option.unloadingCompany.name : ""}</span>
                </GridCell>
            </Grid>
        );
    }
