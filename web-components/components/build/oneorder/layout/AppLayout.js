...
var AppLayout = exports.AppLayout = function (_React$Component) {
    ...
    _createClass(AppLayout, [{
            ...
            this.$headerMain.children('.header_main_search_form').velocity("transition.slideUpBigOut", {
                ...
                complete: function complete() {
                    _this7.$headerMain.children('.header_main_content').velocity("transition.slideDownBigIn", {
                        ...
                        easing: easing_swiftOut,
                        complete: function complete() {
                            // Search bar kapatıldığında aranan metnin silinmesi istenirse aşağısını aç.
        ...
        value: function doSearch() {
            ...
            if (!_lodash2.default.isNil(query) && query.trim().length > 0) {
                query = query.trim();
                this.context.router.push('/ui/' + this.context.appName + '/search/' + encodeURIComponent(query));
            }
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            if (BACKGROUND_COLOR) {
                _lodash2.default.set(backgroundColorStyle, 'backgroundColor', BACKGROUND_COLOR);
            }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', { type: 'text', id: 'searchbox', name: 'q', className: 'header_main_search_input', autoComplete: 'off' }),
                        _react2.default.createElement(
                            'button',
