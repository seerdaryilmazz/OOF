...
export class AddressForm extends TranslatingComponent {
    constructor(props){
        super(props);
        this.state = {};
    }
    ...
    render(){
        ...
        let locale = this.props.location.country ? this.props.location.country.language :  (this.props.location.company ? this.props.location.company.country : null);
        return (
            <Grid>
                <GridCell width="1-2">
                ...
                <GridCell width="1-1">
                    <TextInput label="Street Name" required = {true} uppercase = {{locale: locale}}
                               value = {this.props.location.postaladdress.streetName} readOnly={this.props.readOnly}
