...
export class TaxForm extends TranslatingComponent {
    constructor(props){
        super(props);
        this.state = {};
    }
    ...
    render(){
        ...
        return (
            <Grid>
                ...
                <GridCell width="1-5">
                    <NumberInput label="Tax ID" value = {this.props.company.taxId} oninput = {(value) => this.updateState("taxId", value)} />
                </GridCell>
            </Grid>
        );
