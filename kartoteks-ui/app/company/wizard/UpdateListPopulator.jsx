...
export class UpdateListPopulator{
    ...
    checkFieldForUpdate(configItem){
        ...
        if(!this.isEquals(originalValueToCompare, newValueToCompare)){
            ...
            return {
                notVisible: configItem.notVisible,
                relatedFields: configItem.relatedFields,
    ...
    adjustHiddenItems(updateList){
        let expectHidden = _.reject(updateList, i=>i.notVisible)
        if(_.isEmpty(expectHidden)){
    ...
    populate(config){
        ...
        return this.adjustHiddenItems(updateList);
    }
}